...
\subfloat[Alternative density measures]{\includegraphics[width=.5\textwidth]{../2_analysis/output/figures/baseline_full_time}} \subfloat[Alternative gender gap measures]{\includegraphics[width=.5\textwidth]{../2_analysis/output/figures/baseline_bas_full_time}} \\ 
