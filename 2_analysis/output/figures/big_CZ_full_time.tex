...
\label{fig:big_CZ}
\subfloat[Raw wages]{\includegraphics[width=.5\textwidth]{../2_analysis/output/figures/baseline_big_full_time}} \subfloat[Net of age/race]{\includegraphics[width=.5\textwidth]{../2_analysis/output/figures/basic_big_full_time}} \\ 
