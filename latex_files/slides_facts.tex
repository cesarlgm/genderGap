\begin{frame}{Today the gender gap is \textbf{\alert{narrower}} in denser labor markets}
	\begin{columns}
		\column{0.5\textwidth}
		\input{../2_analysis/output/figures/l_czone_density_2020.tex}
		\column{0.5\textwidth}
...
\begin{frame}{The negative correlation is robust}
	\begin{columns}
		...
		{\tiny\input{../2_analysis/output/figures/l_czone_density_2020_big_CZ.tex}}
		\column{0.5\textwidth}
...
\begin{frame}{It is robust to accounting for individual characteristics}
	\begin{columns}
		\column{.5\textwidth}
		\input{../2_analysis/output/figures/l_czone_density_2020_hum.tex}
		\column{.5\textwidth}
	\end{columns} 
\end{frame}
...
\begin{columns}
	...
	\column{0.5\textwidth}
	\input{../2_analysis/output/figures/baseline_l_czone_density_full_time.tex}
...
\begin{frame}{Robustness}
	\begin{columns}
		...
		\beamerbutton{\hyperlink{slide:map}{With individual controls}}
		\column{0.5\textwidth}
		\input{../2_analysis/output/figures/baseline_w_l_czone_density_full_time.tex}
		\beamerbutton{\hyperlink{slide:map}{Graph without absorb}} 
	\end{columns}
\end{frame}
...
\begin{frame}{Robustness}
	\begin{columns}
		\column{0.5\textwidth}
		\input{../2_analysis/output/figures/baseline_fe_l_czone_density_full_time.tex}
		\beamerbutton{\hyperlink{slide:map}{With individual controls}}
		\column{0.5\textwidth}
	    { \tiny	\input{../2_analysis/output/figures/with_controls_gradients_individual_l_czone_density_full_time.tex}}
		\beamerbutton{\hyperlink{slide:map}{Graph without absorb}} 
	\end{columns}
\end{frame}
...
\begin{frame}{A tale of women's success and male decline in denser labor markets}
	\begin{columns}
		\column{0.5\textwidth}
		\input{../2_analysis/output/figures/lfp_gap_full_time.tex}
		\beamerbutton{\hyperlink{slide:map}{Graph without absorb}}
		\column{0.5\textwidth}
