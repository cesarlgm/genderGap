...
\title{Cities the place of women: local labor markets and the gender wage gap}
\date{\today}
...
\input{introduction_slides.tex}

\input{slides_facts.tex}



%\input{slides_descriptive_facts.tex}



%\input{literature.tex}

%\input{data_slides.tex}
...
%\input{slides_regressions_controls.tex}
